...
baseline = baseline.loc[baseline['condition']=='baseline']
...
df_chek['condition']=get_qd(df_target_pres)[0:-1:2]


all_df = pd.concat([baseline, df_chek])
...
all_df['index_c'] = all_df['index_c'].replace(['baseline', 'delay_q1', 'delay_q2', 'delay_q3', 'delay_q4'], [1, 2,3,4,5])


all_df = all_df.reset_index()
### just with checkerboard and baseline

with open('wmmap6.par', 'w') as out:
