...
df_target_pres['condition']= 'target' #get_q(df_target_pres)

#start delay
df_start_delay = df.copy()
df_start_delay['time']=df['start_delay_ref']
df_start_delay['condition']=get_qd(df_target_pres)
...
all_df['index_c'] = all_df['index_c'].replace(['baseline', 'baselinech', 'checkerboard', 'target', 'delay_q1', 'delay_q2',
'delay_q3', 'delay_q4', 'probe'], [1, 2, 3, 4, 5, 6, 7, 8, 9])


all_df = all_df.reset_index()

with open('wmmap5.par', 'w') as out:
